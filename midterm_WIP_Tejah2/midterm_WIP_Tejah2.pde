...
void draw () {
  if  (state == "scene1") {
    ...
    else if (mouseX>460 && mouseX < 460 +200 && mouseY> 450 && mouseY <450 +100)  { // rectangle rollover highlight 
      fill (0,0,255);
      rect (460, 450, 200, 100);
    }
    ...
    if (mousePressed){
       if (mouseX>width/6 && mouseX < width/6 + 200 && mouseY> 450 && mouseY<450 + 100){ // if you press the left rectangle go to state 2
        ...
        state = "scene2"; 
         ...
         else if (state == "scene2") // when in state 2, if you press the left rectangle go to state 4, right rectangle go to state 5
